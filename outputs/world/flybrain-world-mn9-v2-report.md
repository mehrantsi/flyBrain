...
Status: historical v2 feeding-render checkpoint. The current live full-v783 world and its latest
verification results are documented in the repository `README.md`; counts below describe v2.
